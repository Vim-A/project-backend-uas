...
@section('title', 'Tambah Venue — BeatMeet')
...
<div class="page-shell">
    ...
    <div class="form-card" style="max-width: 580px;">
        ...
        <h2 style="margin:0 0 20px;">Tambah Venue Baru</h2>
        ...
        <form action="{{ route('venues.store') }}" method="POST">
            ...
            <div class="field">
                ...
                <input type="text"
                       ...
                       class="{{ $errors->has('nama_venue') ? 'border-red-500' : '' }}">
                @error('nama_venue')
            ...
            <div class="field">
                ...
                <textarea id="alamat"
                          name="alamat"
                          placeholder="Masukkan alamat lengkap venue">{{ old('alamat') }}</textarea>
                @error('alamat')
                    <p class="small" style="color:#dc2626; margin:4px 0 0;">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="actions" style="margin-top:24px; padding-top:16px; border-top:1px solid var(--line);">
                ...
                <a href="{{ route('venues.index') }}" class="btn">Batal</a>
            </div>
